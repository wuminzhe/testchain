...
pub use srml_balances::Call as BalancesCall;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("testchain"),
    impl_name: create_runtime_str!("testchain"),
    authoring_version: 3,
    spec_version: 4,
    impl_version: 4,
...
construct_runtime!(
    ...
    UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        Balances: srml_balances::{Module, Storage, Config<T>, Event<T>},
        BalancesExt: balances::{Module, Call},
    }
);
